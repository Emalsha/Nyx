...
acl.allow('admin',['/admin/administration','/admin/delete','/admin/managepublicfiles','/view_f/viewfiles','/view_f/view_publicfiles','/admin/management','/users'],['get','post','view']);
