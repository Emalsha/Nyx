...
acl.allow('admin',['/admin/administration','/admin/viewfiles','/view_f/viewfiles','/view_f/view_publicfiles','/admin/management','/users','/admin/server','/admin/server_time'],['get','post','view']);
